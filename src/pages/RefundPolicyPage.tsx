...
import { RotateCcw, Package, AlertTriangle, RefreshCw, Clock, Mail, CheckCircle, XCircle, FileText, Shield, Globe } from 'lucide-react';
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm">
                    {language === 'ar'
                      ? 'مراجعة شروط الاستخدام والخدمة'
                      : 'Review our terms of use and service'}
                  </p>
                </Link>
                <Link
                  to="/delivery"
